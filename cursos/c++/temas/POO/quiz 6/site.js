...
function verificarRespuestas(){
    ...
    var respuestas = ["v","f","v","f","c","c","b","a1,b1","b2,c2","a3,c3"];
    ...
    localStorage.setItem('puntuacion', JSON.stringify({ quizNombre: 'Quiz 6: POO', puntuacion: puntos }));
    
    // Llamar a la función aprobarQuiz de la página principal
    window.parent.postMessage({ tipo: 'puntuacion', quizNombre: 'Quiz 6: POO', puntuacion: puntos }, '*');
