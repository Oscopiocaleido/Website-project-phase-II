...
function verificarRespuestas(){
  ...
  var respuestas = ["f","v","f","v","c","b","b","a1,b1","a2,b2","a3,b3"];
  ...
  localStorage.setItem('puntuacion', JSON.stringify({ quizNombre: 'Quiz 4: Funciones', puntuacion: puntos }));
  
  // Llamar a la función aprobarQuiz de la página principal
  window.parent.postMessage({ tipo: 'puntuacion', quizNombre: 'Quiz 4: Funciones', puntuacion: puntos }, '*');
