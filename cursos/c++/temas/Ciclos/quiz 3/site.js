...
function verificarRespuestas(){
  ...
  var respuestas = ["f","v","f","f","a","a","a","a1,b1", "a2,c2", "a3,c3"];
  //Las preguntas con respuestas multiples deben ir en un solo par de comillas separadas por una coma, por ejemplo "a1,b1,c1"
  //En total solo deben haber 6 respuestas correctas entre las 3 preguntas de seleccion multiple
