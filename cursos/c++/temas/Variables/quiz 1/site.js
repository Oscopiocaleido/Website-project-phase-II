...
function verificarRespuestas(){
    ...
    var respuestas = ["v","f","v","f","a","b","a","a1","a2,b2,c2","a3,b3"];
    ...
    localStorage.setItem('puntuacion', JSON.stringify({ quizNombre: 'Quiz 1: Variables', puntuacion: puntos }));
    
    // Llamar a la función aprobarQuiz de la página principal
    window.parent.postMessage({ tipo: 'puntuacion', quizNombre: 'Quiz 1: Variables', puntuacion: puntos }, '*');
