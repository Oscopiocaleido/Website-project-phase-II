...
function verificarRespuestas(){
    ...
    var respuestas = ["v","f","f","v","a","a","a","a1,c1","a2,b2","b3,c3"];
    ...
    localStorage.setItem('puntuacion', JSON.stringify({ quizNombre: 'Quiz 2: Condicionales', puntuacion: puntos }));
    
    // Llamar a la función aprobarQuiz de la página principal
    window.parent.postMessage({ tipo: 'puntuacion', quizNombre: 'Quiz 2: Condicionales', puntuacion: puntos }, '*');
