...
function verificarRespuestas(){
    ...
    var respuestas = ["f","v","f","f","b","c","a","a1,c1","a2,c2","a3,b3"];
    ...
    localStorage.setItem('puntuacion', JSON.stringify({ quizNombre: 'Quiz 5: Estructuras de Datos', puntuacion: puntos }));
    
    // Llamar a la función aprobarQuiz de la página principal
    window.parent.postMessage({ tipo: 'puntuacion', quizNombre: 'Quiz 5: Estructuras de Datos', puntuacion: puntos }, '*');
